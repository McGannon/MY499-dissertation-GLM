...
MY499_data <- MY499_data %>%
  ...
  relocate(participant_id, .before = 45)
str(MY499_data)

#Extracting cleaned data
MY499_clean <- MY499_data[, 1:45]
str(MY499_clean)
...
#Logistic regression
logistic_model1 <- glm(consent ~ condition, data = MY499_clean)
summary(logistic_model1)
logistic_model2 <- glm(consent ~ condition * class, data = MY499_clean)
summary(logistic_model2)
#Understanding scores
sumunderstanding_correct <- lm_robust(understand_correct ~ condition, data = MY499_data)
summary(sumunderstanding_correct)
sumunderstanding_correct_model2 <- lm_robust(consent ~ condition * understand_correct, data = MY499_data)
summary(sumunderstanding_correct_model2)
understandingq1_correct <- lm_robust(understand_1_correct ~ condition, data = MY499_data)
summary(understandingq1_correct)
understandingq1_correct_model2 <- lm_robust(consent ~ condition * understand_1_correct, data = MY499_data)
summary(understandingq1_correct_model2)
understandingq2_correct <- lm_robust(understand_2_correct ~ condition, data = MY499_data)
summary(understandingq2_correct)
understandingq2_correct_model2 <- lm_robust(consent ~ condition * understand_2_correct, data = MY499_data)
summary(understandingq2_correct_model2)
understandingq3_correct <- lm_robust(understand_3_correct ~ condition, data = MY499_data)
summary(understandingq3_correct)
understandingq3_correct_model2 <- lm_robust(consent ~ condition * understand_3_correct, data = MY499_data)
summary(understandingq3_correct_model2)
understandingq4_correct <- lm_robust(understand_4_correct ~ condition, data = MY499_data)
summary(understandingq4_correct)
understandingq4_correct_model2 <- lm_robust(consent ~ condition * understand_4_correct, data = MY499_data)
